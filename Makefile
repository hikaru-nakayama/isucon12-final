bench: mysql-slow.rotate nginx.rotate
...
deploy1:
	...
	scp -r ./webapp/sql/3_schema_exclude_user_presents.sql isucon:~/webapp/sql
	scp -r ./webapp/sql/setup/1_schema.sql isucon:~/webapp/sql/setup
